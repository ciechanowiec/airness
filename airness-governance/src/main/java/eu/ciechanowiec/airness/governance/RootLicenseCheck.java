 ...
 * it can drift or imply a different license, so the root may contain neither {@code LICENSE} nor
 * {@code LICENSE.TXT}, under any casing. The check reads directory entries rather than Git's
...
public final class RootLicenseCheck {
    ...
    private static final String HEADLINE
        = "License files named LICENSE or LICENSE.TXT must not sit beside the root pom.xml";
    private static final Set<String> FORBIDDEN = Set.of("license", "license.txt");
